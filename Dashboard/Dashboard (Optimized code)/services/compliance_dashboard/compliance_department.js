...
const getBreachesSummaryDep = async (req, res, next) => {
  try {
    let role = req.role;
    ...
    let { from, to, report_type, assigned_to_name, skip, limit } = req.body;
...
const complianceBreachesDep = async (req, res, next) => {
  try {
    let role = req.role;
    let organization = req.organization;
    let department = req.department;
...
const departmentMaxViolationDep = async (req, res, next) => {
  try {
    let role = req.role;
    let organization = req.organization;
    let department = req.department;
...
const topTenRiskyUsersDep = async (req, res, next) => {
  try {
    let role = req.role;
    let organization = req.organization;
    let department = req.department;
...
const repeatedViolationsDep = async (req, res, next) => {
  try {
    let organization = req.organization;
    let department = req.department;
...
module.exports = {
  getBreachesSummaryDep: getBreachesSummaryDep,
  complianceBreachesDep: complianceBreachesDep,
  departmentMaxViolationDep: departmentMaxViolationDep,
  topTenRiskyUsersDep: topTenRiskyUsersDep,
  repeatedViolationsDep: repeatedViolationsDep,
};